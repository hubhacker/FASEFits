...
function coldfits() {
  ...
  coldTop1.src = "/img2/img2_sw_cold_top_1.png";
  var coldTop2 = new Image();
  coldTop2.src = "/img2/img2_sw_cold_top_2.png";
  topArray.push(coldTop1, coldTop2);

  var coldBottom1 = new Image();
  coldBottom1.src = "/img2/img2_sw_cold_bottom_1.png";
  var coldBottom2 = new Image();
  coldBottom2.src = "/img2/img2_sw_cold_bottom_2.png";
  bottomArray.push(coldBottom1, coldBottom2);

  var coldShoes1 = new Image();
  coldShoes1.src = "/img2/img2_sw_cold_shoes_1.png";
  var coldShoes2 = new Image();
  coldShoes2.src = "/img2/img2_sw_cold_shoes_2.png";
  shoesArray.push(coldShoes1, coldShoes2);

  var coldAcc1 = new Image();
  coldAcc1.src = "/img2/img2_sw_cold_acc_1.png";
  var coldAcc2 = new Image();
  coldAcc2.src = "/img2/img2_sw_cold_acc_2.png";
...
function chillyfits() {
  ...
  chillyTop1.src = "/img2/img2_sw_chilly_top_1.png";
  var chillyTop2 = new Image();
  chillyTop2.src = "/img2/img2_sw_chilly_top_2.png";
  topArray.push(chillyTop1, chillyTop2);

  var chillyBottom1 = new Image();
  chillyBottom1.src = "/img2/img2_sw_chilly_bottom_1.png";
  var chillyBottom2 = new Image();
  chillyBottom2.src = "/img2/img2_sw_chilly_bottom_2.png";
  bottomArray.push(chillyBottom1, chillyBottom2);

  var chillyShoes1 = new Image();
  chillyShoes1.src = "/img2/img2_sw_chilly_shoes_1.png";
  var chillyShoes2 = new Image();
  chillyShoes2.src = "/img2/img2_sw_chilly_shoes_2.png";
  shoesArray.push(chillyShoes1, chillyShoes2);

  var chillyAcc1 = new Image();
  chillyAcc1.src = "/img2/img2_sw_chilly_acc_1.png";
  var chillyAcc2 = new Image();
  chillyAcc2.src = "/img2/img2_sw_chilly_acc_2.png";
...
function warmfits() {
  ...
  warmTop1.src = "/img2/img2_sw_warm_top_1.png";
  var warmTop2 = new Image();
  warmTop2.src = "/img2/img2_sw_warm_top_2.png";
  topArray.push(warmTop1, warmTop2);

  var warmBottom1 = new Image();
  warmBottom1.src = "/img2/img2_sw_warm_bottom_1.png";
  var warmBottom2 = new Image();
  warmBottom2.src = "/img2/img2_sw_warm_bottom_2.png";
  bottomArray.push(warmBottom1, warmBottom2);

  var warmShoes1 = new Image();
  warmShoes1.src = "/img2/img2_sw_warm_shoes_1.png";
  var warmShoes2 = new Image();
  warmShoes2.src = "/img2/img2_sw_warm_shoes_2.png";
  shoesArray.push(warmShoes1, warmShoes2);

  var warmAcc1 = new Image();
  warmAcc1.src = "/img2/img2_sw_warm_acc_1.png";
  var warmAcc2 = new Image();
  warmAcc2.src = "/img2/img2_sw_warm_acc_2.png";
...
function hotfits() {
  ...
  hotTop1.src = "/img2/img2_sw_hot_top_1.png";
  var hotTop2 = new Image();
  hotTop2.src = "/img2/img2_sw_hot_top_2.png";
  topArray.push(hotTop1, hotTop2);


  var hotBottom1 = new Image();
  hotBottom1.src = "/img2/img2_sw_hot_bottom_1.png";
  var hotBottom2 = new Image();
  hotBottom2.src = "/img2/img2_sw_hot_bottom_2.png";
  bottomArray.push(hotBottom1, hotBottom2);

  var hotShoes1 = new Image();
  hotShoes1.src = "/img2/img2_sw_hot_shoes_1.png";
  var hotShoes2 = new Image();
  hotShoes2.src = "/img2/img2_sw_hot_shoes_2.png";
  shoesArray.push(hotShoes1, hotShoes2);

  var hotAcc1 = new Image();
  hotAcc1.src = "/img2/img2_sw_hot_acc_1.png";
  var hotAcc2 = new Image();
  hotAcc2.src = "/img2/img2_sw_hot_acc_2.png";
